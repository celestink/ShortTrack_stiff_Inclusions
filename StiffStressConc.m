...
%      k1=Angs{k}(10:12,1)
   k2=Angs{k}(5,1)
%      Angs{k}(10:12,1)=Angs{k}(10:12,3);
     Angs{k}(5,1)=Angs{k}(5,3);
%      Angs{k}(10:12,3)=k1;
     Angs{k}(5,3)=k2;
%      k3=Angs{k}(:,1);
%      Angs{k}(:,1)=Angs{k}(:,3);
%      Angs{k}(:,3)=k3;
%      k4= Angs{k}([2:4 8],1);
%      Angs{k}([2:4 8],1)= Angs{k}([2:4 8],2);
%      Angs{k}([2:4 8],2)=k4;
 end
%  if k==9
%      k9=Angs{k}(11:12,1)
%      Angs{k}(11:12,1)=Angs{k}(11:12,3);
%      Angs{k}(11:12,3)=k9;
%      k10= Angs{k}(:,1);
%      Angs{k}(11:12,3)=k9;
%  end
...
Y1=Str1(:,1:6)./Str1noi(:,1:6);
Y2=Str1(:,7:9)./Str1noi(:,7:9);
Z=Str1(1:3,:)./Str1noi(1:3,:);
Y3=Str1(:,10:15)./Str1noi(:,10:15);
V2=Mis1(:,7:9);
W2=Mis1(1:3,:);
...
hold(axes16,'on');
scatter(X2,StrConc(:,7),ba,'d','filled','MarkerEdgeColor','b','MarkerFaceColor','b');hold on
scatter(X2,StrConc(:,8),ba,'o','filled','MarkerEdgeColor','r','MarkerFaceColor','r');hold on
scatter(X2,StrConc(:,9),ba,'*','filled','MarkerEdgeColor','k','MarkerFaceColor','k');hold on
xlabel('Vertical distance from the rail top surface (mm)','FontName','Times New Roman', 'FontSize',ft);
ylabel('Stress concentration factors at inclusion  (MPa)','FontName','Times New Roman',  'FontSize',ft);
...
%hold(axes1,'on');
scatter(X1,Z(1,:),ba,'d','filled','MarkerEdgeColor','b','MarkerFaceColor','b');hold on
scatter(X1,Z(2,:),ba,'o','filled','MarkerEdgeColor','r','MarkerFaceColor','r');hold on
scatter(X1,Z(3,:),ba,'*','filled','MarkerEdgeColor','k','MarkerFaceColor','k');hold on
...
ylabel('Stress concentration factors at inclusion ','FontName','Times New Roman',  'FontSize',ft);
...
linestyle={'d','o','*'};
linecolor={'k','r','b'};
scatter(X1,abs(u11(j,:)),ba,'d','filled','MarkerEdgeColor','k','MarkerFaceColor','k'),hold on;
scatter(X1,abs(v11(j,:)),ba,'o','filled','MarkerEdgeColor','r','MarkerFaceColor','r'),hold on;
scatter(X1,abs(w11(j,:)),ba,'*','filled','MarkerEdgeColor','b','MarkerFaceColor','b'),hold on;
xlabel('Lateral position (mm)','FontName','Times New Roman',  'FontSize',ft)
